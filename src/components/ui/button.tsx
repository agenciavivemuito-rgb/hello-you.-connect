  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glow: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_20px_hsl(188_100%_50%/0.4)] hover:shadow-[0_0_30px_hsl(188_100%_50%/0.6)]",
        hero: "bg-gradient-to-r from-cyan-500 to-violet-500 text-background font-bold hover:opacity-90 shadow-[0_0_30px_hsl(188_100%_50%/0.3)] hover:shadow-[0_0_40px_hsl(188_100%_50%/0.5)] transition-all duration-300",
