      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in delay-100">
            ...
            <span className="gradient-text">conectam marcas</span> a resultados
            reais
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in delay-200">
            Transformamos estratégia em performance. Tráfego pago, social media,
            automações, sites e softwares personalizados para escalar seu
            negócio.
          </p>
