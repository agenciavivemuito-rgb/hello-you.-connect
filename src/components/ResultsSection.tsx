...
const benefits = [
  {
    icon: TrendingUp,
    title: "Performance",
    description: "Campanhas otimizadas para maximizar seu ROI e resultados mensuráveis.",
    stat: "+300%",
    statLabel: "ROI médio",
  },
  {
    icon: Users,
    title: "Crescimento",
    description: "Aquisição de clientes qualificados através de estratégias data-driven.",
    stat: "10x",
  ...
  },
  {
    icon: Zap,
    title: "Automação",
    description: "Processos automatizados que economizam tempo e aumentam eficiência.",
    stat: "80%",
  ...
  },
  {
    ...
    description: "Estrutura preparada para escalar seu negócio de forma sustentável.",
    stat: "∞",
    statLabel: "potencial",
  },
];
    ...
    <section id="resultados" className="py-20 md:py-32 relative">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <span className="text-primary text-sm font-medium uppercase tracking-wider">Resultados</span>
          <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-4">
            O que você pode <span className="gradient-text">esperar</span>
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Entregamos resultados tangíveis que impactam diretamente o crescimento do seu negócio.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              {/* Stat */}
              <div className="text-4xl font-bold gradient-text mb-1">{benefit.stat}</div>
